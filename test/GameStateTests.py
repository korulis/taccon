...
from src.game_state import get_initial_game_state, generate_state


class GameStateTests(unittest.TestCase):

    def test_skipper_move_gets_discarded(self):
        # Arrange
        move1 = {"nextPlayer": "O",
        ...
        # Act
        new_state, current_data = generate_state(game_state, new_move)
